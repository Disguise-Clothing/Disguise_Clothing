window.addEventListener("load", event => {
  ...
  function productHeading() {
      ...
      const product = {
          ...
          value: 899,
          images: [{
                  img: 'https://i.imgur.com/58trzF1.png'
              },
              {
                  img: 'https://i.imgur.com/9CBJCfB.png'
              },
              {
                  img: 'https://i.imgur.com/HDruUxr.png'
              },
              {
                  img: 'https://i.imgur.com/r3zVjC8.png'
              },
              {
                  img: 'https://i.imgur.com/bgSpFQf.png'
              },
              {
                  img: 'https://i.imgur.com/ClebeTE.png'
              }
          ]
      }
      ...
      function getDisccount() {
          ...
          discount = product.value - (product.value - 799);
